...
def args_parser():
    ...
    parser.add_argument('--latent_size', type=int, default=196, help='latent_size')
    parser.add_argument('--filter_shape', type=int, default=3, help='filter_shape')
